...
public class JPAProduct {
	...
	/**
	 * this function take all products
	 * @return
	 */

	public static ArrayList<Product>  selectAllP(){
	...
	/**
	 * this function take all products with the same name 
	 * @return
	 */

	public static ArrayList<Product>  selectNameP(String name){
	...
	public static void updateP(Product product) {
		...
		try {
			...
			PreparedStatement pst = conn.prepareStatement(
					"UPDATE " + tableName + " SET (name_p = ?,  measure = ?, initial = ?, stock = ?) " +" WHERE codep = ? AND codesg = ?"); //prepare querry
			//set values	
